...
// import { InputGroup, Button, Form, FormControl, Container, Row, Col, Modal } from 'react-bootstrap/'
...
//           <Form.Group className="mb-3" controlId="formBasicCheckbox">
//             <Form.Check name="genderFilter" value={filter.genderFilter} onChange={handleInput} type="text" placeholder="¿Mujeres, hombres o ambos?"/>
//           </Form.Group>
